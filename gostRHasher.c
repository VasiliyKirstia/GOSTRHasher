...
void Encrypt(HashCodeLength hash, void *data, uint64_t data_bits_count, uint8_t *dest){
	...
	result[bytes_count] = (1 << (uint8_t)data_bits_count & 7); //записываем единицу
